...
public class KKHSupplier1 {
	...
	public KKHSupplier_MasterObject getSupplierObject() {
		return supplierObject;
	}
	public void setSupplierObject(KKHSupplier_MasterObject supplierObject) {
		this.supplierObject = supplierObject;
	}
	public KKHSupplier1(Long id,  String email, Long contact, String pt, String country, String state,
			String district, String location, String document, Long masterId, Date start_date, Date end_date,
			int iteration_info, int isletest_Iteration, KKHSupplier_MasterObject supplierObject) {
		super();
		this.id = id;
		this.email = email;
		this.contact = contact;
	...
	public String toString() {
		return "KKHSupplier1 [id=" + id + ", email=" + email + ", contact=" + contact + ", pt=" + pt
